...
2. Na versão mais recente, abra a área **Assets** e baixe `Nexus-Game-Launcher-Setup-1.1.4.exe`.
...
Quem não quiser instalar pode baixar `Nexus-Game-Launcher-Portable-1.1.4.exe` na mesma página de Releases. A versão portátil abre diretamente e oferece os mesmos recursos principais.
...
- `Nexus-Game-Launcher-Setup-1.1.4.exe` — instalador recomendado com escolha da pasta de destino;
- `Nexus-Game-Launcher-Portable-1.1.4.exe` — versão portátil.
...
2. Crie e envie uma tag que corresponda ao `package.json`, por exemplo `v1.1.4`.
